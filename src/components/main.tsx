    ...
    <main className="main">
      ...
      <section>
        ...
        <div className="carousel">
          ...
          >
            <div>
              <img src="https://images.pexels.com/photos/546819/pexels-photo-546819.jpeg" alt="Serviço 1" />
              <p className="legend">Desenvolvimento de Software</p>
            </div>
            <div>
              <img src="https://images.pexels.com/photos/5582873/pexels-photo-5582873.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Serviço 2" />
              <p className="legend">Consultoria em TI</p>
            </div>
            <div>
              <img src="https://images.pexels.com/photos/5632402/pexels-photo-5632402.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="Serviço 3" />
